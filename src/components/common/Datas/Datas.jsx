        ...
        <div className="grid gap-5 row-gap-8 lg:grid-cols-2">
          <div className="flex flex-col justify-center">
            <div className="max-w-xl mb-6">
              <div>
                <p className="inline-block px-3 py-px mb-4 text-xs font-semibold tracking-wider uppercase rounded-full bg-teal-accent-400 text-indigo-600">
                ¡Nueva funcionalidad!
                </p>
              </div>
              ...
              Descubre patrones ocultos,
                ...
                y toma decisiones que{' '}
                <span className="inline-block text-indigo-600 ">
                impulsarán tu negocio
                </span>
              </h2>
              <p className="text-base text-gray-700 md:text-lg">
              Nuestra herramienta de análisis de datos desbloquea el poder de tu información comercial, permitiéndote entender mejor las tendencias de mercado, el comportamiento del cliente y el rendimiento del producto. Transforma datos en decisiones estratégicas y lleva tu negocio al siguiente nivel.
            ...
            <a
              href="/"
              aria-label=""
              className="inline-flex items-center font-semibold transition-colors duration-200 text-indigo-600 hover:text-indigo-400"
            >
              Aprende más
              <svg
          ...
          <div className="relative">
            <svg
              className="absolute w-full text-indigo-500"
              fill="currentColor"
              viewBox="0 0 600 392"
            >
